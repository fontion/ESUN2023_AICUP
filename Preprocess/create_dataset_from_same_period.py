...
from create_dataset_from_same_db import parse_args
from create_dataset_from_same_db import combine_all_parts
from create_dataset_from_same_db import load_and_update
...
# def combine_all_parts(df_train, db_temp):
